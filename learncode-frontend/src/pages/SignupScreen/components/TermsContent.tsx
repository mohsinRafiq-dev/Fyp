export default function TermsContent() {
  return (
    <div className="prose text-gray-700 text-sm leading-relaxed">
      ...
      <p className="mb-4">
        By accessing and using LearnCode AI, you accept and agree to be
      ...
      <p className="mb-4">
        Permission is granted to temporarily use LearnCode AI for personal,
      ...
      <p className="mb-4">
        LearnCode AI provides a secure environment for executing code.
      ...
      <p className="mb-4">
        In no event shall LearnCode AI or its suppliers be liable for any
        damages arising out of the use or inability to use the
        materials on LearnCode AI, even if authorized representative has
