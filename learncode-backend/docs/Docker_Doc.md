# LearnCode AI - Code Execution Architecture Documentation
...
LearnCode AI is a secure online code execution platform that allows users to run Python, JavaScript, and C++ code in isolated Docker containers. The system ensures security through containerization, resource limits, and network isolation.
...
#### 1. Python Image (`learncode-ai-python-base`)
...
#### 2. JavaScript Image (`learncode-ai-javascript-base`)
...
#### 3. C++ Image (`learncode-ai-cpp-base`)
...
```powershell
# Windows
cd "C:\Development\LearnCode\learncode-ai-backend"
.\setup-docker.bat
...
# Remove all learncode-ai-related images
docker images | Where-Object {$_.Repository -like "*learncode-ai*"} | ForEach-Object {docker rmi $_.ImageId}
...
docker build --no-cache -t learncode-ai-python-base -f docker/Dockerfile.python .
...
The LearnCode AI code execution system provides a secure, scalable platform for running user code in isolated environments. The Docker-based architecture ensures security while maintaining performance and ease of use.
